...
// --- BAZA DANYCH MODUŁÓW ---
// UWAGA: treści modułów dla PLECAKA INDYWIDUALNEGO (tools, orientation, shelter,
// nutrition, hygiene, medical) zostały przeniesione do HTML (index.html), do bloków
// .module-data wewnątrz każdego kafelka #wybor-plecaka. getModuleData() czyta je stamtąd.
// Baza poniżej pozostaje jako źródło danych dla PLECAKA RODZINNEGO oraz jako fallback.
const moduleDatabase = {
    ...
    'tools-family': { 
        ...
        items: [
            ...
            'zapałki sztormowe w pudełku, 2 opak. (2 x 8 szt.)',
    ...
    'nutrition-family': { 
        ...
        items: [
           ...
           'lio&dried food: Zupa krem z pieczarek z makaronem 85 g (341 kcal), 2 szt',
            ...
            'tabletki do uzdatniania wody, 40 szt.',
            'pudełko na tabletki, 1 szt.',
            'indywidualny filtr do wody, 2 szt.',
            'menażka: garnek 1100 ml + pokrywka 650 ml, 1 szt.',
			'składany kubek silikonowy z pokrywką 200 ml, 4 szt.',
            'składany łyżkowidelec, 4 szt.',
            'składana kuchenka na paliwo stałe i drewno, 1 szt.',
            'paliwo stałe w tabletkach do kuchenki, 2 tuby (2 x 8 szt.)'
        ] 
    },
